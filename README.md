...
> **Gilbert Kwak** | 최초 생성: 2026-04-05 | 현재 버전: **v1.3**

[![Version](https://img.shields.io/badge/version-v1.3-blue)](https://github.com/GilbertKwak/prompt-engineering-system/releases)
...
| 엔진 | ID | 기능 | 문서 |
|------|-----|------|------|
| 자동개선 | PE-1 | 프롬프트 약점 탐지 → 재작성 | [docs/agent1/](./docs/agent1/README.md) |
| 자동증식 | PE-2 | 다목적 변형 버전 생성 | [docs/agent2/](./docs/agent2/README.md) |
| 자동검증 | PE-3 | 5차원 품질 채점 | [docs/agent3/](./docs/agent3/README.md) |
...
> 관리자: Gilbert Kwak | 다음 리뷰: 2026-05 (v1.4 — support/ 세부 파일 완성)
